...
class SuperAdminTestingDocumentationController extends Controller
{
    public function index(): Response
    {
        ...
        return Inertia::render('SuperAdminTestingDocumentation/Index', [
            'summary' => [
            ...
            'knownIssues' => [
                [
                    ...
                    'description' => 'PDF export links should use <a> tags instead of Inertia <Link> to avoid raw PDF output appearing in the browser.',
                    'status' => 'handled',
                ],
                [
                ...
                [
                    ...
                    'description' => 'Do not add EventGuest->answers() using guest_id because event_answers no longer stores guest_id directly.',
                    'status' => 'handled',
                ],
                [
                    'title' => 'Expense amount column may vary',
                    'description' => 'Expense reports should safely detect amount, total_amount, cost, price, estimated_amount, or actual_amount.',
                    'status' => 'handled',
                ],
            ],

            'readiness' => [
                'status' => $failedTests === 0 && $pendingTests === 0 ? 'Ready for final demo' : 'Needs review',
    ...
    private function demoChecklist(): array
    {
        return [
            [
                ...
                'description' => 'Confirm that Super Admin can access dashboard, events, users, activity logs, and reports.',
                'status' => 'ready',
            ],
            [
