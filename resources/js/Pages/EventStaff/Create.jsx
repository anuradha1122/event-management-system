...
export default function Create({ auth, event, statuses }) {
    ...
    const submit = (e) => {
        ...
        post(route('events.staff.store', event.id));
    };

    return (
        <AuthenticatedLayout user={auth.user}>
            <Head title={`Add Staff - ${event.title}`} />
                    ...
                    <form onSubmit={submit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Example: Registration Desk / Catering Coordinator"
                            />
                        ...
                        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    placeholder="Example: staff@example.com"
                                />
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full rounded border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                rows="4"
                                placeholder="Special responsibilities, availability, instructions..."
                            />
