...
export default function Edit({ auth, event, vendor, categories, statuses }) {
    ...
    const submit = (e) => {
        ...
        put(route('events.vendors.update', [event.id, vendor.id]));
    };

    return (
        <AuthenticatedLayout user={auth.user}>
            <Head title={`Edit Vendor - ${event.title}`} />
