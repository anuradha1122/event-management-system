                            ...
                            <div>
                                ...
                                <div className="mt-1 flex items-center gap-3">
                                    ...
                                    <span className="text-sm text-gray-500">
                                        {data.theme_color || 'Default system color will be used'}
                                    </span>
                                </div>

                                {errors.theme_color && (
                                    <p className="mt-1 text-sm text-red-600">{errors.theme_color}</p>
                                )}
                            </div>
                        </div>
